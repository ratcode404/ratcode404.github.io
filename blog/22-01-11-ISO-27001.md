...
At this point I finally (and probably way too late) implemented the GitLab connection and set up the repo. I used [this TeX.gitignore](https://github.com/github/gitignore/blob/main/TeX.gitignore) to keep the repo tidy and clean.
