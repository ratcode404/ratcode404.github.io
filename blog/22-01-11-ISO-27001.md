...
Using this custom configuration will create a directory in a different path, move the PDF file from there to a third location, and then update the vscode PDF preview.
